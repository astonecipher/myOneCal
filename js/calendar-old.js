...
function calendarAddEvent() {
   ...
   $('#buzz-calendar-container').slideUp( "slow", function() {
	    var url = "http://www.filelogix.com/buzz/calendar/widget/addEvent" + + $('#buzz-calendar-add-event').serialize();;
		$('#buzz-calendar-container').html("Loading...");
		$.get(url, function(data) {
    	      $('#buzz-calendar-container').html("<br>" + data);
			  $('#buzz-calendar-container').slideDown( "slow", function() {
				  $("#buzz-calendar-container .scrollable-area").animate({height:'100%'}, 1000);
