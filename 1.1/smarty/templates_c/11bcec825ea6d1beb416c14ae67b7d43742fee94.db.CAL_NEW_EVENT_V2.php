<?php /* Smarty version Smarty-3.1.13, created on 2013-10-17 15:25:22
         compiled from "db:cal_new_event_v2" */ ?>
<?php /*%%SmartyHeaderCode:1705864418525f0a5b90a787-65461308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11bcec825ea6d1beb416c14ae67b7d43742fee94' => 
    array (
      0 => 'db:cal_new_event_v2',
      1 => 1382052317,
      2 => 'db',
    ),
  ...
  'nocache_hash' => '1705864418525f0a5b90a787-65461308',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_525f0a5ba70b91_03075286',
  'variables' => 
  array (
    'navHomeActive' => 0,
    'navCreateActive' => 0,
...
<?php if ($_valid && !is_callable('content_525f0a5ba70b91_03075286')) {function content_525f0a5ba70b91_03075286($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
  <head>
    <base href="/buzz/">
    <meta charset="utf-8">
  ...
  <div class="row">
	<div class="span8">
		...
		<div class="row">
			<div class="span4">
				<label>Title</label>
				<input type="text" class="span4" placeholder="Event Title" name="eventTitle" value="<?php echo $_smarty_tpl->tpl_vars['eventTitle']->value;?>
">
			</div>		  
			<div class="span4">
		...
		<div class="row">
		       <div class="well span4 hide slidedown" id="ticketed">
				<legend>Ticketing Details:</legend>
					<div class="span2">
					<label>Cost?</label>
					 <input type="text" class="money span2" name="eventCost" placeholder="0.00" value="<?php echo $_smarty_tpl->tpl_vars['eventCost']->value;?>
">
					</div>
					<div class=span3">
					<label>Ticketing Website:</label>
					 <input type="text" class="span3" name="ticketURL" placeholder="http://" value="<?php echo $_smarty_tpl->tpl_vars['ticketURL']->value;?>
">
					</div>
			</div>
		</div>
